...
export default defineComponent({
  name: 'GithubLogo',
  props: {
    modifierClass: { type: String, default: '', required: false },
    spanClass: { type: String, default: '', required: false },
  },
});
</script>
